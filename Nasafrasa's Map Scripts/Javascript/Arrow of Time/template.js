...
environment.push(
    {
        _id : "TimbalandEnvironment.[0]Environment.[17]TimbalandLogo",
        _lookupMethod : "Exact",
        _active : false
    }
)
environment.push(
    {
        _id : "TimbalandEnvironment.[0]Environment.[20]TimbalandLogo (1)",
        _lookupMethod : "Exact",
        _active : false
    }
)
environment.push(
    {
        _id : "TimbalandEnvironment.[0]Environment.[21]TimbalandLogo (2)",
        _lookupMethod : "Exact",
        _active : false
    }
)
environment.push(
    {
        _id : "TimbalandEnvironment.[0]Environment.[22]TimbalandLogo (3)",
        _lookupMethod : "Exact",
        _active : false
    }
)
...
environment.push(
    {
        _id : "TimbalandEnvironment.[0]Environment.[28]BackColumns",
        _lookupMethod : "Exact",
        _active : false
    }
)
environment.push(
    {
        _id : "TimbalandEnvironment.[0]Environment.[28]BackColumns.[0]BackColumnNeon",
        _lookupMethod : "Exact",
        _active : false
    }
)
environment.push(
    {
        _id : "TimbalandEnvironment.[0]Environment.[28]BackColumns.[1]BackColumnNeon",
        _lookupMethod : "Exact",
        _active : false
    }
)
...
environment.push(
    {
        _id : "TimbalandEnvironment.[0]Environment.[5]Buildings",
        _lookupMethod : "Exact",
        _active : false
    }
)
environment.push(
    {
        _id : "TimbalandEnvironment.[0]Environment.[5]Buildings.[0]NearBuildingRight",
        _lookupMethod : "Exact",
        _active : false
    }
)
environment.push(
    {
        _id : "TimbalandEnvironment.[0]Environment.[5]Buildings.[1]NearBuildingLeft",
        _lookupMethod : "Exact",
        _active : false
    }
)
...
environment.push(
    {
        _id : "TimbalandEnvironment.[0]Environment.[9]Spectrograms",
        _lookupMethod : "Exact",
        _active : false
    }
)
environment.push(
    {
        _id : "TimbalandEnvironment.[0]Environment.[9]Spectrograms.[0]Spectrogram",
        _lookupMethod : "Exact",
        _active : false
    }
)
environment.push(
    {
        _id : "TimbalandEnvironment.[0]Environment.[9]Spectrograms.[1]Spectrogram",
        _lookupMethod : "Exact",
        _active : false
    }
)
...
environment.push(
    {
        _id : "TimbalandEnvironment.[0]Environment.[3]MainStructure",
        _lookupMethod : "Exact",
        _active : false
    }
)
environment.push(
    {
        _id : "TimbalandEnvironment.[0]Environment.[4]TopStructure",
        _lookupMethod : "Exact",
        _active : false
    }
)
environment.push(
    {
        _id : "TimbalandEnvironment.[0]Environment.[6]TrackMirror",
        _lookupMethod : "Exact",
        _active : false
    }
)
environment.push(
    {
        _id : "TimbalandEnvironment.[0]Environment.[6]TrackMirror.[0]TrackMirrorSetDepth",
        _lookupMethod : "Exact",
        _active : false
    }
)
environment.push(
    {
        _id : "TimbalandEnvironment.[0]Environment.[7]TrackConstruction",
        _lookupMethod : "Exact",
        _active : false
    }
)
environment.push(
    {
        _id : "TimbalandEnvironment.[0]Environment.[23]GlowLineL",
        _lookupMethod : "Exact",
        _active : false
    }
)
environment.push(
    {
        _id : "TimbalandEnvironment.[0]Environment.[24]GlowLineR",
        _lookupMethod : "Exact",
        _active : false
    }
)
...
customEvents.push({
    ...
    _data: {
        _track: "demoTrack",
        _duration: 16,
        _position: [[0, 0, 0, 0, "easeOutQuint"], [0, 0, -300, 2, "easeOutQuint"], [0, 0, 200, 4, "easeOutQuint"]],
        _rotation: [[0, 0, 0, 0, "easeOutQuint"], [0, 0, 180, 2, "easeOutQuint"]]
    }
})
...
customEvents.push({
    ...
    _data: {
        _track: "playerDemo",
        _duration: 16,
        _position: [[0, 0, 0, 0, "easeOutQuint"], [0, 0, -300, 2, "easeOutQuint"], [0, 0, -100, 4, "easeOutQuint"]],
        _rotation: [[0, 0, 0, 0, "easeOutQuint"], [0, 0, 180, 2, "easeOutQuint"]]
    }
})
...
customEvents.push({
    ...
    _data: {
        _track: "demoTrack",
        _duration: 16,
        _position: [[0, 0, -300, 0, "easeOutQuint"], [0, 0, 0, 0.75, "easeOutQuint"]],
        _rotation: [[0, 0, 0, 0, "easeOutQuint"]]
    }})
...
customEvents.push({
    ...
    _data: {
        _track: "playerDemo",
        _duration: 0,
        _position: [[0, 0, 25, 0, "easeOutQuint"]],
        _rotation: [[0, 0, 0, 0, "easeOutQuint"]]
    }
})
